...
test('grant de faturamento soma 85k só com conta e e-mail certos', () => {
  ...
  assert.equal(multicursos.value, 2_000_000);
  ...
  assert.equal(multicursosCresceu.value, 2_012_500);
...
test('bonus de 2M do Multicursos desbloqueia todos os marcos e continua somando', () => {
