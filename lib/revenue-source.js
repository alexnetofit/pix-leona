/**
 * lib/revenue-source.js — Coleta de faturamento nas fontes (Guru, Paddle, Pagou e dLocal Go),
...
export function assignUniqueSubscribers({
  ...
  return {
    unique: (Number(guruCount) || 0) + paddleExclusive.length + dlocalExclusive.length + pagouExclusive.length,
    paddle: paddle.size,
